...
function App() {
  ...
  async function getData(){
    ...
    // console.log(search);
    try {
      let response = await fetch(`${URL}weather?q=${search}&units=imperial&appid=${API_KEY}`);
  ...
  // utilize useEffect() React hook to make API call
  useEffect(() => {
    // invoke getData() function
    getData();
  }, []);   // empty list/array [] for initial render only
